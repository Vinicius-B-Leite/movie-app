...
import { View, Text, SafeAreaView, StatusBar, TextInput, Image, FlatList, Modal, ToastAndroid, ActivityIndicator } from "react-native";
...
export default function Home() {
    ...
    return (
        <View style={styles.conteiner}>
            ...
            {
                isLoading === true ?
                    <ActivityIndicator style={styles.loaging} size={50} color="#fff"/>
                    :
                    <>
